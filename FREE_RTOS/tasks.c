...
{
	volatile char	*pxTopOfStack;		/*< Points to the location of the last item placed on the tasks stack.  THIS MUST BE THE FIRST MEMBER OF THE STRUCT. */
	...
	char			*pxStack;			/*< Points to the start of the stack. */
...
PRIVILEGED_DATA static volatile char xMissedYield 						= ( portBASE_TYPE ) pdFALSE;
PRIVILEGED_DATA static volatile char xNumOfOverflows 					= ( char ) 0;
 ...
 */
static tskTCB *prvAllocateTCBAndStack( unsigned short usStackDepth, char *puxStackBuffer ) PRIVILEGED_FUNCTION;
